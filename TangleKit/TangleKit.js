...
//  Modifications by Nikola Sibalic December 2018.
...
Tangle.classes.TKToggle = {
    ...
    initialize: function (element, options, tangle, variable) {
        ...
        this.element.title = "Click to change";
    ...
    updateStyle: function () {
        if (this.isHovering) { this.element.addClass("TKAdjustableNumberHover"); }
...
//  TKList
//
//  Click to swotch between 0 and number of child notes

Tangle.classes.TKList = {

    initialize: function (element, options, tangle, variable) {
        element.addEvent("click", function (event) {
            var selectedElement = tangle.getValue(variable);
            selectedElement = (selectedElement + 1) % element.getChildren().length;
            tangle.setValue(variable, selectedElement);
        });
        this.element = element;
        this.element.title = "Click to change";
        this.initializeHover();
...
Tangle.classes.TKAdjustableNumber = {
    ...
    initialize: function (element, options, tangle, variable) {
        ...
        this.element.title = "Drag to change";
        this.initializeHover();
        this.initializeHelp();
        this.initializeDrag();
    },
